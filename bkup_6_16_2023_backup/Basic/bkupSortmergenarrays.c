...
void sort_merge(int (*arraylist)[10], int m_list[], int num_array, int num_elements, int count)
{
	int i, j;
	...
	int *temp = arraylist[num_array-1];
	...
	int *temp2 = arraylist[num_array-2];
	...
	sort_merge(arraylist, m_list, num_array, num_elements, count);
}
...
void sort(int (*arraylist)[10], int num_array, int num_elements)
{
	...
	sort_merge(arraylist, m_list, num_array, num_elements, 0);
